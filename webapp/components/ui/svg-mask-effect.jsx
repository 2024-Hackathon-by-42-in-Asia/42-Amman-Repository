...
export const MaskContainer = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="tw-absolute tw-inset-0 tw-bg-black tw-h-full tw-w-full tw-z-0 tw-opacity-50" />
        <div
          onMouseEnter={() => {
            setIsHovered(true);
          }}
      ...
      <div className="tw-w-full tw-h-full tw-flex tw-items-center tw-justify-center tw- tw-text-white">
        {revealText}
      </div>
    </motion.div>
  );
